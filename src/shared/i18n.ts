...
const dictionaries = {
  en: flatten({
    ...
    party: {
      ...
      hintCompact:
        'Tap a seat to edit that player, drag seats to swap positions, and use recent names for quick replacement.',
      ...
      recentPlayersHint: 'Drag onto a seat or tap while editing',
  ...
  ko: flatten({
    ...
    party: {
      ...
      hintCompact:
        '좌석을 눌러 플레이어를 수정하고, 좌석 카드를 드래그해 위치를 바꾸고, 최근 이름으로 빠르게 교체하세요.',
      ...
      recentPlayersHint: '좌석에 드래그하거나 편집 중 탭해서 적용',
      teamColors: '팀 색상',
      quickActions: '빠른 작업',
